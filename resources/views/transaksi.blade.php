                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form action="{{ url('/transaksi/cari') }}" method="get" class="form-inline">
                                <input type="text" name="cari" value="{{ request('cari') }}" class="form-control" placeholder="Cari ..">
                        ...
                        <tbody>
                            @foreach ($transaksi as $t)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $t->kategori->kategori ?? 'tidak ada kategori' }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('/transaksi/edit/' . $t->id) }}"
                                            class="btn btn-sm btn-warning">Edit</a>
                                        <a href="{{ url('/transaksi/hapus/' . $t->id) }}"
